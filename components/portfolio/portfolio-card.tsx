...
export default function PortfolioCard({ item }: PortfolioCardProps) {
  return (
    <div className="card overflow-hidden rounded-3xl border border-border transition-all duration-300 hover:shadow-lg h-full">
      <Link href={`/projects/${item.slug}`} className="block h-full flex flex-col">
        ...
        <div className="p-4 md:p-6 flex flex-col flex-grow">
          <h3 className="font-medium text-foreground text-lg mb-2">{item.title}</h3>
